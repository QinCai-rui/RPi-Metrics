...
You can also <u>_**remote poweroff**_</u> and <u>_**remote update**_</u> your Pi, from anywhere in the world, provided that the server is reachable from the wider internet. (Check out <https://pi-monitor.qincai.xyz> to see it yourself!)
